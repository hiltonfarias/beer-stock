...
public class BeerServiceTest {
    ...
    @Test
    void whenValidBeerNameIsGivenThenReturnedBeer() throws BeerNotFoundException {
    ...
    @Test
    void whenNotRegisteredBerNameIsGivenThenThrowAnException() {
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenListBeerIsCalledThenReturnedAListOfBeers() {
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedFoundBeer = beerMapper.toModel(expectedFoundBeerDTO);
    ...
    @Test
    void whenListBeerIsCalledThenReturnedAnEmptyListOfBeers() {
    ...
    @Test
    void whenIncrementIsBiggerThanMaxThenThrowException() {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenIncrementAfterSumIsBiggerThanMaxThenThrowException() {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenIncrementIsCalledWithInvalidIdThrowException() {
        int quantityToIncrement = 10;
